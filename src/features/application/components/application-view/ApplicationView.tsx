...
import { renderDocs } from "../render-docs/RenderDocs";
  ...
  return (
    <>
      ...
      <Popup isShow={isShow} onClose={() => setIsShow(false)}>
        <div className="w-[708px] h-[765px] bg-[#ffffff] rounded-[20px] py-[17px] px-5">
          ...
          <h1 className="font-medium text-[#171822] text-[18px]">
            Hujjatlar <span>[{countDocs(selectedDoctor?.Doctor_file[0])}]</span>
          </h1>
          <div className="flex flex-col gap-3">
            {renderDocs(selectedDoctor?.Doctor_file[0])}
          </div>
          ...
          <div className="flex justify-end">
            <div className="mt-10 flex gap-5">
              <Button
                ...
                className="h-[44px]! border-none! hover:opacity-80!"
              >
